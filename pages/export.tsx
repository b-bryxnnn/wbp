  ...
  return (
    <div className="animate-fade-in max-w-xl mx-auto px-4 py-8">
      ...
      <div className="card-royal space-y-4">
        ...
        <a href="/api/export?type=pdf" className="btn-gold w-full text-center flex items-center justify-center gap-2 py-4 text-lg">
          <FileText size={20} /> Export PDF
        </a>
        <a href="/api/export?type=excel" className="btn-outline-gold w-full text-center flex items-center justify-center gap-2 py-4 text-lg">
