...
const schoolLogos = [
	...
	{ name: "โรงเรียนเตรียมอุดมศึกษาน้อมเกล้า", url: "" },
	{ name: "โรงเรียนเทพศิรินทร์ร่มเกล้า", url: "" },
	...
	{ name: "โรงเรียนมัธยมวัดหนองจอก", url: "" },
					...
					<div className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-5 gap-4">
						{schoolLogos.map((s, i) => (
							<div key={i} className="flex flex-col items-center gap-2 text-center">
								...
								<span className="text-xs text-royal-500 leading-tight max-w-[120px]">
									{s.name}
								</span>
							</div>
						))}
